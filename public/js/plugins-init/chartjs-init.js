    ...
    var dzSparkLine = function() {
                ...
                new Chart(barChart_1, {
                    ...
                    data: {
                        ...
                        datasets: [{
                            ...
                            borderColor: 'rgba(78, 104, 254, 1)',
                            borderWidth: "0",
                            backgroundColor: 'rgba(78, 104, 254, 1)'
                        }]
                    },
                    options: {
                        legend: false,
        ...
        var barChart2 = function() {
            if (jQuery('#barChart_2').length > 0) {
                ...
                barChart_2gradientStroke.addColorStop(0, "rgba(78, 104, 254, 1)");
                barChart_2gradientStroke.addColorStop(1, "rgba(78, 104, 254, 0.5)");
        ...
        var barChart3 = function() {
            ...
            if (jQuery('#barChart_3').length > 0) {
                ...
                barChart_3gradientStroke.addColorStop(0, "rgba(78, 104, 254, 1)");
                barChart_3gradientStroke.addColorStop(1, "rgba(78, 104, 254, 0.5)");
                ...
                new Chart(lineChart_1, {
                    ...
                    data: {
                        ...
                        datasets: [{
                            ...
                            pointBackgroundColor: 'rgba(78, 104, 254, 1)'
                        }]
                    },
                    options: {
                        legend: false,
        ...
        var lineChart2 = function() {
            ...
            if (jQuery('#lineChart_2').length > 0) {
                ...
                lineChart_2gradientStroke.addColorStop(0, "rgba(78, 104, 254, 1)");
                lineChart_2gradientStroke.addColorStop(1, "rgba(78, 104, 254, 0.5)");
                ...
                new Chart(lineChart_2, {
                    ...
                    data: {
                        ...
                        datasets: [{
                            ...
                            borderWidth: "2",
                            backgroundColor: 'transparent',
                            pointBackgroundColor: 'rgba(78, 104, 254, 0.5)'
                        }]
                    },
                    options: {
                        legend: false,
        ...
        var lineChart3 = function() {
            ...
            if (jQuery('#lineChart_3').length > 0) {
                ...
                lineChart_3gradientStroke1.addColorStop(0, "rgba(78, 104, 254, 1)");
                lineChart_3gradientStroke1.addColorStop(1, "rgba(78, 104, 254, 0.5)");
                ...
                new Chart(areaChart_1, {
                    ...
                    data: {
                        ...
                        datasets: [{
                            ...
                            borderWidth: "1",
                            backgroundColor: 'rgba(78, 104, 254, .5)',
