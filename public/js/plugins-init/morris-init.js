    ...
    var dzMorris = function() {
        ...
        var donutChart = function() {
            Morris.Donut({
                ...
                resize: true,
                redraw: true,
                colors: ['#707070', 'rgb(78, 104, 254)', '#1bd084'],
                //responsive:true,
        ...
        var lineChart = function() {
            ...
            let line = new Morris.Line({
                ...
                lineColors: ['rgb(78, 104, 254)'], //here
                lineWidth: 1,
                hideHover: 'auto',
                pointSize: 0,
                axes: false
        ...
        var lineChart2 = function() {
            ...
            Morris.Area({
                ...
                lineWidth: 3,
                hideHover: 'auto',
                lineColors: ['rgb(78, 104, 254)', 'rgb(27, 208, 132)', '#707070'],
                resize: true
        ...
        var barChart = function() {
            if (jQuery('#morris_bar').length > 0) {
                ...
                Morris.Bar({
                    ...
                    ykeys: ['a', 'b', 'c'],
                    labels: ['A', 'B', 'C'],
                    barColors: ['#6733f5', '#1bd084', '#ff9f00'],
                    hideHover: 'auto',
                    gridLineColor: 'transparent',
                    resize: true,
                    barSizeRatio: 0.25,
        ...
        var areaChart = function() {
            ...
            Morris.Area({
                ...
                lineColors: ['#707070', 'rgb(16, 202, 147)', 'rgb(78, 104, 254)'],
                xkey: 'period',
                ykeys: ['smartphone', 'windows', 'mac'],
                labels: ['Phone', 'Windows', 'Mac'],
                pointSize: 0,
