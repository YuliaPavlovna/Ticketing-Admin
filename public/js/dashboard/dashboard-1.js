                ...
                new Chart(chart_widget_1, {
                    ...
                    data: {
                        ...
                        datasets: [{
                            ...
                            borderColor: '#6733f5',
                            pointBackgroundColor: '#6733f5',
                            pointBorderColor: '#6733f5',
                            borderWidth: 6,
                            borderRadius: 10,
                            pointHoverBackgroundColor: '#6733f5',
                            pointHoverBorderColor: '#6733f5',
                ...
                var config = {
                    ...
                    data: {
                        ...
                        datasets: [{
                            ...
                            borderWidth: "8",
                            backgroundColor: 'rgba(78, 104, 254, 0.1)'
                    ...
                    new Chart(chart_widget_2, {
                        ...
                        data: {
                            ...
                            datasets: [{
                                ...
                                hoverBackgroundColor: 'rgba(78, 104, 254, 1)'
                            }]
                        },
                        options: {
                            legend: false,
