    ...
    var dzChartlist = function() {
        ...
        var polarAreaCharts = function() {
            var options = {
                ...
                fill: {
                    opacity: 1,
                    colors: ['#707070', '#BFBFBF', '#F3F3F3', '#6733f5']
                },
                stroke: {
                    width: 0,
                    colors: undefined
        ...
        var areaChart = function() {
                if (jQuery('#areaChart_2').length > 0) {
                    ...
                    areaChart_2gradientStroke.addColorStop(0, "rgba(78, 104, 254, 0.0)");
                    areaChart_2gradientStroke.addColorStop(1, "rgba(78, 104, 254, 0)");
