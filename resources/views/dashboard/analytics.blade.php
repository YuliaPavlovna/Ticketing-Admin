              ...
              <div class="media align-items-center">
                <span class="mr-4">
                  <svg width="50" height="53" viewBox="0 0 50 53" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect width="7.11688" height="52.1905" rx="3.55844" transform="matrix(-1 0 0 1 49.8184 0)" fill="#6733f5"/>
                    <rect width="7.11688" height="37.9567" rx="3.55844" transform="matrix(-1 0 0 1 35.585 14.2338)" fill="#6733f5"/>
                    <rect width="7.11688" height="16.6061" rx="3.55844" transform="matrix(-1 0 0 1 21.3516 35.5844)" fill="#6733f5"/>
                    <rect width="8.0293" height="32.1172" rx="4.01465" transform="matrix(-1 0 0 1 8.0293 20.0732)" fill="#6733f5"/>
                  </svg>
                </span>
                  ...
                  <div class="align-items-center row mx-0 border-bottom p-4">
                    ...
                    <div class="mr-3 col-2 col-sm-1">
                      ...
                      <svg width="26" height="27" viewBox="0 0 26 27" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <rect width="3.71426" height="27" rx="1.85713" transform="matrix(-1 0 0 1 26 0)" fill="#6733f5"/>
                        <rect width="3.71426" height="19.6364" rx="1.85713" transform="matrix(-1 0 0 1 18.5723 7.36365)" fill="#6733f5"/>
                        <rect width="3.71426" height="8.59091" rx="1.85713" transform="matrix(-1 0 0 1 11.1436 18.4091)" fill="#6733f5"/>
                        <rect width="4.19045" height="16.6154" rx="2.09522" transform="matrix(-1 0 0 1 4.19043 10.3846)" fill="#6733f5"/>
                      </svg>
                    </div>
                ...
                <div class="card-body">
                  <div class="d-flex mb-4 align-items-center">
                    <div class="d-inline-block position-relative donut-chart-sale mr-3">
                      <span class="donut" data-peity='{ "fill": ["rgb(78, 104, 254)", "rgba(244, 244, 244, 1)"],   "innerRadius": 31, "radius": 10}'>2/8</span>
                  ...
                  <div class="d-flex align-items-center">
                    <div class="d-inline-block position-relative donut-chart-sale mr-3">
                      <span class="donut" data-peity='{ "fill": ["rgb(78, 104, 254)", "rgba(244, 244, 244, 1)"],   "innerRadius": 31, "radius": 10}'>7/9</span>
              ...
              <div class="row mx-0">
                <div class="col-6 px-0 d-flex align-items-center mb-3">
                  <svg class="mr-3" width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect width="25" height="25" rx="12.5" fill="#6733f5"/>
                  </svg>
                  <div>
