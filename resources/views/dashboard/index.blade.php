          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="d-flex justify-content-between mt-4">
                ...
                <div class="pr-2">
                  <svg width="20" height="8" viewBox="0 0 20 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect width="20" height="8" rx="4" fill="#6733f5"/>
                  </svg>
              ...
              <div class="event-bx owl-carousel">
                <div class="items">
                  <div class="image-bx">
                    ...
                    <div class="info">
                      <p class="fs-18 font-w600"><a href="{!! url('/event-detail'); !!}" class="text-black">International Live Choice Festivals (2020)</a></p>
                ...
                <div class="items">
                  <div class="image-bx">
                    ...
                    <div class="info">
                      <p class="fs-18 font-w600"><a href="{!! url('/event-detail'); !!}" class="text-black">Envato Atuhor Community Fun Hiking at Sibayak Mt.</a></p>
                ...
                <div class="items">
                  <div class="image-bx">
                    ...
                    <div class="info">
                      <p class="fs-18 font-w600"><a href="{!! url('/event-detail'); !!}" class="text-black">Envato Indonesian Authors Meetup 2020</a></p>
