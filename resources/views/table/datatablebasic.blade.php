      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="table-responsive">
            <table id="example-1" class="display min-w850">
              <thead>
                <tr>
                  <th>Name</th>
                  <th>Position</th>
            ...
            <table id="example-3" class="display min-w850">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>Female</td>
                  <td>M.COM., P.H.D.</td>
                  <td><a href="javascript:void(0);"><strong class="text-black">987 654 3210</a></strong></td>
                  <td><a href="javascript:void(0);"><strong class="text-black">info@example.com</a></strong></td>
                  <td>2011/07/25</td>
                  <td>
                    <div class="d-flex">
                      <a href="#" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-pencil"></i></a>
                ...
                <tr>
                  ...
                  <td>Male</td>
                  <td>B.COM., M.COM.</td>
                  <td><a href="javascript:void(0);"><strong class="text-black">(123) 4567 890</a></strong></td>
                  <td><a href="javascript:void(0);"><strong class="text-black">info@example.com</a></strong></td>
                  <td>2009/01/12</td>
                  <td>
                    <div class="d-flex">
                ...
                <tr>
                  ...
                  <td>Male</td>
                  <td>B.COM., M.COM.</td>
                  <td><a href="javascript:void(0);"><strong class="text-black">123 456 7890</a></strong></td>
                  <td><a href="javascript:void(0);"><strong class="text-black">info@example.com</a></strong></td>
                  <td>2012/03/29</td>
                  <td>
                    <div class="d-flex">
