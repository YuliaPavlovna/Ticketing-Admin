                ...
                <tr class="alert alert-dismissible">
                  ...
                  <td>
                    <span>
                      ...
                      <a href="javascript:void(0);" data-placement="top" data-toggle="tooltip" data-dismiss="alert" aria-label="Close"><i class="fa fa-close color-danger"></i></a>
                    </span>
                  </td>
                </tr>
                <tr class="alert alert-dismissible">
                  ...
                  <td><span><a href="javascript:void()" class="mr-4" data-toggle="tooltip"
                    data-placement="top" title="Edit"><i
                    class="fa fa-pencil color-muted"></i> </a><a href="javascript:void(0);" data-placement="top" data-toggle="tooltip" data-dismiss="alert" aria-label="Close"><i class="fa fa-close color-danger"></i></a></span>
                  </td>
                </tr>
                <tr class="alert alert-dismissible">
                  <td>Milk Powder</td>
