  ...
  <div class="deznav-scroll">
    ...
    <ul class="metismenu" id="menu">
      ...
      <ul aria-expanded="false">
        ...
        <li><a href="{!! url('/event-detail'); !!}">Event Detail</a></li>
    ...
    <div class="copyright">
      <p><strong>Tara Ticketing Dashboard</strong> © 2021 All Rights Reserved</p>
      <p>Made with <span class="heart"></span> by Tara</p>
    </div>
  </div>
</div>
<!--**********************************
